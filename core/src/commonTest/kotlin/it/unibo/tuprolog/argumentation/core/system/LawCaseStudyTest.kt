        ...
        val run = { queryList : List<String>, solver : MutableSolver ->
            arg2pScope {
                queryList.map { query ->
                    ...
                    solver.solve("structured" call "query"(
                        Struct.parse(query, Arg2pSolver.default().operators()), X), SolveOptions.allLazilyWithTimeout(TimeDuration.MAX_VALUE)).first().let {
